...
Review the code changes for quality, consistency, and maintainability.

## Prerequisites

Before running this skill, the developer should have:
...
Run these commands and check for issues:
...
See [docs/code-reviewer/README.md](../docs/code-reviewer/README.md) for full guidelines.
