...
export function getLayoutById(layoutId: string): LayoutTemplate | null {
...
export function getLayoutSlots(layoutId: string): LayoutSlot[] | null {
  const layout = getLayoutById(layoutId);
  return layout ? layout.slots : null;
}

export function getLayoutSlotCount(layoutId: string): number | null {
  const layout = getLayoutById(layoutId);
