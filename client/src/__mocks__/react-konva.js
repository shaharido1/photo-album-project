...
export const Layer = React.forwardRef(({ children, ...props }, ref) => (
...
export const Rect = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-rect" {...props} />
));
Rect.displayName = 'Rect';

// Mock Group component
export const Group = React.forwardRef(({ children, ...props }, ref) => (
...
export const Image = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-image" {...props} />
));
Image.displayName = 'Image';

// Mock Transformer component
export const Transformer = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-transformer" {...props} />
));
Transformer.displayName = 'Transformer';

// Mock Text component
export const Text = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-text" {...props} />
));
Text.displayName = 'Text';

// Mock Circle component
export const Circle = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-circle" {...props} />
));
Circle.displayName = 'Circle';

// Mock Line component
export const Line = React.forwardRef((props, ref) => (
  <div ref={ref} data-testid="konva-line" {...props} />
));
Line.displayName = 'Line';

// Mock useImage hook
export const useImage = (url) => {
  const mockImage = url ? { width: 100, height: 100 } : null;
